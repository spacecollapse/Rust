...
Батник для открытия раста(запускать хоть откуда, при запуске выберите папку с игрой, и запустите батник еще раз)(если ошибки какието, удалите файл rust.txt в документа) - https://github.com/spacecollapse/Rust/releases/download/rust/openrust.bat
