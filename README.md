...
Скачиваете прогу, "**лучше запустить от имени администратора**". Потом нажимаем "включить обход" выбираем папку с "Rust"  Если раст не открылся жмем "Открыть Rust" Нажимаем "Выбрать dll для инжекта" выбираем яит и инжектим, если не инжектитсч через кнопку **инжектим через ExtremeInjector**
...
**Если у вас 11винда, молитесь чтоб он работал**

Если написано "обход включён", но все равно проблемы - https://github.com/spacecollapse/abphel
