...
Батник для открытия раста(запускать хоть откуда, при запуске выберите папку с игрой) - https://github.com/spacecollapse/Rust/releases/download/rust/openrust.bat
