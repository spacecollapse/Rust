...
Скачиваете прогу, "**запускаем от имени администратора**". Потом нажимаем "включить обход" выбираем папку с "Rust"  Если раст не открылся жмем "Открыть Rust" Нажимаем "инжект ваш dll" если хотите заинжектить какую-то стороннюю длл, либо инжект superiority которая заинжектит последнюю версию superiority
